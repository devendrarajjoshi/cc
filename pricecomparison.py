...
headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/115.0.0.0 Safari/537.3'}
# import manan as m
flipkart=''
ebay=''
croma=''
...
window = Tk()
window.wm_title("Price comparison extention")
window.minsize(1500,700)

lable_one =  Label(window, text="Enter Product Name :", font=("Times New Roman", 20))
...
l1 =  Label(window, text="Flipkart", font=("Times New Roman", 20))
l2 =  Label(window, text="ebay", font=("Times New Roman", 20))
l3 =  Label(window, text="Croma", font=("Times New Roman", 20))
l4 =  Label(window, text="Amazon", font=("Times New Roman", 20))
l6 =  Label(window, text="All urls", font=("Times New Roman", 20))
l8 =  Label(window, text="Loding.....", font=("Times New Roman", 30))
...
l6.place(relx=0.6, rely=0.6, anchor="center")
...
box6 =  Text(window, height=14, width=90, yscrollcommand=scrollbar.set, fg="blue", cursor="hand2")
box6.place(relx=0.6, rely=0.8, anchor="center")
